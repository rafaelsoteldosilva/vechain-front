...
import ConfirmDeletionOfCategoryWithVideos from "../components/Dialogs/ConfirmDeletionOfCategoryWithVideos";
...
function ManageCategories({
   ...
   const [confirmDeletionDialogOpen, setConfirmDeletionDialogOpen] =
      useState(false);
   const [categoryNameToConfirmDeletion, setCategoryNameToConfirmDeletion] =
      useState("");
   ...
   return (
      <React.Fragment>
         ...
         <ConfirmDeletionOfCategoryWithVideos
