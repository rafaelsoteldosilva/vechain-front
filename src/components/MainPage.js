...
const MainPage = ({ render }) => {
	...
	return (
		<React.Fragment>
			<PersistentLeftDrawer drawerOpen={drawerOpen} closeDrawer={handleDrawerClose} drawerWidth={drawerWidth} />
			<Main open={drawerOpen} sx={{ marginLeft: `${marginLeftWhenDrawerOpens}px` }}>
				<Grid container direction="column">
					<Grid item>
						<Header openDrawer={handleDrawerOpen} marginLeftWhenDrawerOpens={marginLeftWhenDrawerOpens} />
					</Grid>
